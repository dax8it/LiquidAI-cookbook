...
/// Translates the internal `vzhome://` URL scheme — baked into Stage B's
...
/// An earlier attempt bulk-renamed `vzhome://` → `liquid-telco-triage://`
...
public enum DeepLinkRebrand {
    /// Rewrites `vzhome://X` → `<brand-scheme>://X` for display. Use
    ...
    public static let internalScheme = "vzhome://"
}
